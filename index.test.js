// test("Check that after submit button is clicked a value is in the list", t => {
//   const result = ["Buy sausages"].length;
//   t.equal(result, 1);
// });

// test("check if the todo item text matches user's input", t => {
//   const result = document.querySelector("#toDo");
//   const expected = t.equal(result, xx); // targeting a text input of crated todo item
// });

// test("Check that the input correctly renders on the webpage", t => {
//   const input = document.querySelector("#toDo");
//   input.value = "Walk my cat";
//   const submitButton = document.querySelector("button");
//   submitButton.click();
//   // Here we will grab the result from the DOM
//   // Check that it equals 'Walk my cat'
//   // Reset the input to ''
// });
